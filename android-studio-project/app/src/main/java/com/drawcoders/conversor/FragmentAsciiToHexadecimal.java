 ...
 */
public class FragmentAsciiToHexadecimal extends FragmentGenericConvert {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.output_option.setVisibility(View.VISIBLE);
        this.output_option.setText(getString(R.string.option_ascii_to_hexadecimal));
        this.output_option.setChecked(true);

        this.input.setHint(getString(R.string.hint_input_ascii_to_hexadecimal));
        this.input.setTypeface(Typeface.MONOSPACE);

        this.output.setHint(getString(R.string.hint_output_ascii_to_hexadecimal));
        this.output.setTypeface(Typeface.MONOSPACE);

        input_title.setText(getString(R.string.input_title_ascii_to_hexadecimal));
        ...
        this.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!value_output.isEmpty()){
                    ...
                    String subject = String.format(getString(R.string.share_subject_ascii_to_hexadecimal), getString(R.string.app_name));
                    String body = String.format(getString(R.string.share_value_ascii_to_hexadecimal), value_input, value_output);
        ...
        // Configuraciones
        this.setup(R.string.converted_ascii_to_hexadecimal);
    ...
    public void convert(Boolean show_msg) {
        ...
        if(this.output_option.isChecked())
            this.output.setText(this.conv.strToHexPrefix(in, "\\x", ""));
        else
            this.output.setText("0x" + this.conv.strToHexPrefix(in, "", ""));
