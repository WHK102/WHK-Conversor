 ...
 */
public class FragmentAsciiToSha1 extends FragmentGenericConvert {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.input.setHint(getString(R.string.hint_input_ascii_to_sha1));
        this.input.setTypeface(Typeface.MONOSPACE);

        this.output.setHint(getString(R.string.hint_output_ascii_to_sha1));
        this.output.setTypeface(Typeface.MONOSPACE);

        input_title.setText(getString(R.string.input_title_ascii_to_sha1));
        ...
        this.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!value_output.isEmpty()){
                    ...
                    String subject = String.format(getString(R.string.share_subject_ascii_to_sha1), getString(R.string.app_name));
                    String body = String.format(getString(R.string.share_value_ascii_to_sha1), value_input, value_output);
        ...
        // Configuraciones
        this.setup(R.string.converted_ascii_to_sha1);
    ...
    public void convert(Boolean show_msg) {
        ...
        this.output.setText(this.conv.SHA1(in));
