 ...
 */
public class FragmentAsciiToRc4 extends FragmentGenericConvert {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.output_title = (TextView)rootView.findViewById(R.id.output_title);
        ...
        this.arguments_container.setVisibility(View.VISIBLE);
        this.arguments_title.setText(getString(R.string.arguments_title_ascii_to_rc4));
        this.arguments_value.setHint(getString(R.string.arguments_hint_ascii_to_rc4));

        this.input.setHint(getString(R.string.hint_input_ascii_to_rc4));
        this.input.setTypeface(Typeface.MONOSPACE);

        this.output.setHint(getString(R.string.hint_output_ascii_to_rc4));
        this.output.setTypeface(Typeface.MONOSPACE);

        input_title.setText(getString(R.string.input_title_ascii_to_rc4));
        output_title.setText(getString(R.string.output_title_ascii_to_rc4));
        ...
        this.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String value_key = arguments_value.getText().toString();
                ...
                if(!value_output.isEmpty()){
                    ...
                    String subject = String.format(getString(R.string.share_subject_ascii_to_rc4), getString(R.string.app_name));
                    String body = String.format(getString(R.string.share_value_ascii_to_rc4), value_input, value_key, value_output);
        ...
        // Configuraciones
        this.setup(R.string.converted_ascii_to_rc4);
    ...
    public void convert(Boolean show_msg) {
        ...
        this.output.setText(this.conv.RC4(in, arguments_value.getText().toString()));
