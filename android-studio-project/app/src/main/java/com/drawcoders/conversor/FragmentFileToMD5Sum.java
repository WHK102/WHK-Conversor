 ...
 */
public class FragmentFileToMD5Sum extends FragmentGenericConvert {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.output.setHint(getString(R.string.hint_output_file_to_md5sum));
        ...
        this.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!value.isEmpty()){
                    ...
                    String subject = String.format(getString(R.string.share_subject_file_to_md5sum), getString(R.string.app_name), filename);
                    String body = String.format(getString(R.string.share_value_file_to_md5sum), filename, output.getText().toString().trim());
        ...
        // Configuraciones
        this.setup(R.string.converted_file_to_md5sum);
    ...
    public void convert(Boolean show_msg) {
        ...
        this.output.setText(this.conv.checkMD5Sum(in));
