 ...
 */
public class FragmentOctalToAscii extends FragmentGenericConvert {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.input.setHint(getString(R.string.hint_input_octal_to_ascii));
        this.input.setTypeface(Typeface.MONOSPACE);

        this.output.setHint(getString(R.string.hint_output_octal_to_ascii));
        this.output.setTypeface(Typeface.MONOSPACE);

        input_title.setText(getString(R.string.input_title_octal_to_ascii));
        ...
        this.share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!value_output.isEmpty()){
                    ...
                    String subject = String.format(getString(R.string.share_subject_octal_to_ascii), getString(R.string.app_name));
                    String body = String.format(getString(R.string.share_value_octal_to_ascii), value_input, value_output);
        ...
        // Configuraciones
        this.setup(R.string.converted_octal_to_ascii);
    ...
    public void convert(Boolean show_msg) {
        ...
        this.output.setText(this.conv.octalToStr(in));
